 ...
 */ (function (a, b) {
  ...
  "use strict";
  var c = "animation.gsap",
    d = window.console || {},
    f = Function.prototype.bind.call(d.error || d.log || function () {}, d);
  a ||
    f(
      "(" +
        c +
    ...
    a.Scene.extend(function () {
      var d = this,
        f = function () {
          d._log &&
            (Array.prototype.splice.call(arguments, 1, 0, "(" + c + ")", "->"),
        ...
        (g = function () {
          if (a) {
            ...
            a.repeat && a.repeat() === -1
              ? c === "DURING" && a.paused()
                ? a.play()
                : c !== "DURING" && !a.paused() && a.pause()
              : b != a.progress() &&
                (d.duration() === 0
                  ? b > 0
                    ? a.play()
                    : a.reverse()
                  : d.tweenChanges() && a.tweenTo
                  ? a.tweenTo(b * a.duration())
                  : a.progress(b).pause());
          }
        }),
        (d.setTween = function (c, j, o) {
          var h, q, p, m, n, k, l, i;
          arguments.length > 1 &&
            (arguments.length < 3 && ((o = j), (j = 1)), (c = b.to(c, j, o)));
          try {
            e ? (h = new e({ smoothChildTiming: !0 }).add(c)) : (h = c),
              h.pause();
          } catch (a) {
            return (
              f(
          ...
          if (
            (a && d.removeTween(),
            (a = h),
            c.repeat && c.repeat() === -1 && (a.repeat(-1), a.yoyo(c.yoyo())),
            d.tweenChanges() &&
              !a.tweenTo &&
              f(
                2,
            ...
            a &&
              ...
              d.triggerElement() &&
              d.loglevel() >= 2 &&
              ((q = b.getTweensOf(d.triggerElement())),
              (p = d.controller().info("vertical")),
              q.forEach(function (b, d) {
                var a = b.vars.css || b.vars,
                  c = p
                    ? a.top !== void 0 || a.bottom !== void 0
                    : a.left !== void 0 || a.right !== void 0;
                if (c)
                  return (
                    f(
                      2,
            ...
            parseFloat(TweenLite.version) >= 1.14)
          ) {
            (m = a.getChildren ? a.getChildren(!0, !0, !1) : [a]),
              (n = function () {
                f(
                  2,
            ...
            for (k = 0, l, i; k < m.length; k++)
              (l = m[k]),
                i !== n &&
                  ((i = l.vars.onOverwrite),
                  (l.vars.onOverwrite = function () {
                    i && i.apply(this, arguments), n.apply(this, arguments);
                  }));
          }
          return f(3, "added tween"), g(), d;
        }),
        (d.removeTween = function (b) {
          return (
            a &&
              (b && a.progress(0).pause(),
              a.kill(),
              (a = void 0),
              f(3, "removed tween (reset: " + (b ? "true" : "false") + ")")),
            d
          );
        });
    });
